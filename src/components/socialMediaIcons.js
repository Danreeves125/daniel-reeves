...
const SocialIcons = () => {
    ...
    return (
        <Icons>
            <Icon key="1">
                <Link to={socialLink.linkedin} title="Linked" target="_blank">
            ...
            <Icon key="2">
                <Link to={socialLink.twitter} title="Twitter" target="_blank">
            ...
            <Icon key="3">
                <Link to={socialLink.github} title="Github" target="_blank">
